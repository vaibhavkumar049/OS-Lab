...
the process table to report to its parent process is known as a zombie process.
...
the parent sleeps for 50 seconds, hence doesn’t call wait() and the child process’s entry still in the table  
*/
